...
if($_SERVER['REQUEST_METHOD'] =='POST')
{
    ...
    $sql = "UPDATE usuarios GET usu_nome = '$nome', usu_senha = '$senha', usu_ativo = '$ativo' WHERE usu_id ='$id'";
...
<body>
    ...
    <div>
        <ul class="menu">
            ...
            <li class="menuloja"><a href="./areacliente/loja.php">LOJA<a>
            <li>
            </li>
        </ul>
    </div>
