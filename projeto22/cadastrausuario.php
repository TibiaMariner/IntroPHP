...
if ($_SERVER["REQUEST_METHOD"]== 'POST')
{
    ...
    #VALIDAÇÃO DE USUARIO, SE EXISTE JÁ EXISTE
    ...
    if($cont == 1)
    {
        echo "<script>window.alert('USUARIO NAO DISPONIVEL');</script>";
    }
    else
     {
        ...
        #CADASTRO USUARIO E JOGA MENSAGEM NA TELA E DERICIONA PARA LISTA USUARIO
