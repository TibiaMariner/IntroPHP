...
#JA LISTA OS USUARIOS DO MEU BANCO
$sql = "SELECT * FROM usuarios WHERE usu_ativo = 's'";
$retorno = mysqli_query($link, $sql);


#JA FORÇA TRAZER s NA VARIAVEL ATIVO
$ativo = 's';
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if ($ativo == 's') {
        ...
        $sql = "SELECT * FROM usuario WHERE usu_ativo = 'n' ";
        $retorno = mysqli_query($link, $sql);
    }
...
<head>
    ...
    <link ref="stylesheet" href="./css/estiloadm.css">
